...
(function () {
  ...
  function setupKeyboardHandling() {
    /* No JS that touches layout — prevents jumps */
  }
  ...
  function renderChat() {
    ...
    html += '<input type="text" id="chat-input" class="chat-input" placeholder="' + UI.t('chat_placeholder') + '" autocomplete="off" enterkeyhint="send">';
